...
public class MainLauncher {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (opcion >1 && opcion <7 && MainLauncher.miClinica == null) {
				System.out.println(ProjectStrings.CLINICANULL);
			} else {
				switch(opcion) {
					case 1: generarClinica(sc);
						break;
						
					case 2: altaPaciente(sc);
							
						break;
					case 3: eliminaPaciente(sc);
							
						break;
					case 4: modificaPaciente(sc);
							
						break;
					case 5: buscaPacientes(sc);
						
					    break;
					case 6: listaPacientes();
	...
	private static void modificaPaciente(Scanner sc) {
		...
		opcion = leerIntTeclado(sc);
		switch(opcion) {
			case 1: atributoAModificar = Paciente.AtributosPaciente.NOMBRE;
			break;
			case 2: atributoAModificar = Paciente.AtributosPaciente.APELLIDOS;
			break;
			case 3: atributoAModificar = Paciente.AtributosPaciente.DNI;
			break;
			case 4: atributoAModificar = Paciente.AtributosPaciente.FNAC;
			break;
			case 5: atributoAModificar = Paciente.AtributosPaciente.TFNO;
			break;
			default: atributoAModificar = Paciente.AtributosPaciente.EMAIL;
		}
	...
	private static void buscaPacientes(Scanner sc) {
		...
		opcion = leerIntTeclado(sc);
		switch(opcion) {
			case 1: atributoBusqueda = Paciente.AtributosPaciente.NOMBRE;
			break;
			case 2: atributoBusqueda = Paciente.AtributosPaciente.APELLIDOS;
			break;
			case 3: atributoBusqueda = Paciente.AtributosPaciente.DNI;
			break;
			case 4: atributoBusqueda = Paciente.AtributosPaciente.FNAC;
			break;
			case 5: atributoBusqueda = Paciente.AtributosPaciente.TFNO;
			break;
			default: atributoBusqueda = Paciente.AtributosPaciente.EMAIL;
		}
	...
	public static void subMenuTratamientos(Paciente p, Scanner sc) {
		...
		do {
			...
			opcion = leerIntTeclado(sc);
			switch(opcion) {
				case 1: ponerTratamiento(p,sc);
				break;
				case 2: eliminarTratamiento(p,sc);
				break;
				case 3: cobrarTratamiento(p,sc);
				break;
				case 4: buscarTratamientos(p,sc);
				break;
				case 5: listarTratamientos(p);
				break;
				default: seguir = false;
			}
		} while (seguir);
	...
	private static void buscarTratamientos(Paciente p, Scanner sc) {
		...
		opcion = leerIntTeclado(sc);
		switch(opcion) {
			case 1: atributoBusqueda = Tratamiento.AtributosTratamiento.CODIGO;
			break;
			case 2: atributoBusqueda = Tratamiento.AtributosTratamiento.DESCRIPCION;
			break;
			case 3: atributoBusqueda = Tratamiento.AtributosTratamiento.FECHA;
			break;
			case 4: 
			case 5: atributoBusqueda = Tratamiento.AtributosTratamiento.COBRADO;
			break;
			default: atributoBusqueda = Tratamiento.AtributosTratamiento.PRECIO;
		}
		System.out.println("Ahora introduzca el valor a buscar del campo seleccionado:");
